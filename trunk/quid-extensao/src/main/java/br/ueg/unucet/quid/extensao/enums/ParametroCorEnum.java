...
/**
 * Enum que identifica os tipos de cores disponiveis no framework.
 * @author QUID
 *
 */
public enum ParametroCorEnum {
	...
	DARKGRAY, DARKGREY, DARKGREEN, DARKKHAKI, DARKMAGENTA, DARKOLIVEGREEN, DARKORANGE, DARKORCHID, DARKRED, DARKSALMON,
